...
prot=1;
count=1;
inf_limit=[5,7.5,10,12.5];
sup_limit=[7.5,10,12.5,15];
Y={0,0,0,0};
...
como1=comodulogram(Y{1},lowf2:fstep:highf2,lowf1:fstep/2:highf1,n_fs);
como2=comodulogram(Y{2},lowf2:fstep:highf2,lowf1:fstep/2:highf1,n_fs);
como3=comodulogram(Y{3},lowf2:fstep:highf2,lowf1:fstep/2:highf1,n_fs);
como4=comodulogram(Y{4},lowf2:fstep:highf2,lowf1:fstep/2:highf1,n_fs);
...
nombre=strcat('C:\Users\meli__000\Desktop\Melisa\Doctorado\BandsCoupling\PAC_DELTA\Open\',name(a,:),'_',lfp{a}(i,:));
save(nombre,'como1','como2','como3','-mat')
saveas(a,strcat('C:\Users\meli__000\Desktop\Melisa\Doctorado\BandsCoupling\PAC_DELTA\Open\',name(a,:),'_',lfp{a}(i,:)),'png')
close(a)
