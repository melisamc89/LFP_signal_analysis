                ...
                if ~(prot=='C') tf=1; end
                    if tf==1
                       [sr sl]=ReadStartTime(pos);
                        ...
                        COMODOphase(x1,n_fs,10,3,18,'Expecting');
                        subplot(2,2,2)
                        [meanp2 peakp2]=COMODOphase(x2,n_fs,9,3,18,'Waiting');
                        COMODOphase(x2,n_fs,10,3,18,'Resting');
                        subplot(2,2,3)
                        [meanp3 peakp3]=COMODOphase(x3,n_fs,9,3,18,'Running Slow');
                        COMODOphase(x3,n_fs,10,3,18,'Slow');
                        subplot(2,2,4)
                        [meanp4 peakp4]=COMODOphase(x4,n_fs,9,3,18,'Running Fast');
                        COMODOphase(x4,n_fs,10,3,18,'Fast');
                        saveas(i,strcat('C:\Users\meli__000\Desktop\Melisa\Doctorado\BandsCoupling\Modulation\Speeds\',name(a,:),'_',lfp{a}(i,:)),'png')
                        close(i)
...
nombre=strcat('C:\Users\meli__000\Desktop\Melisa\Doctorado\BandsCoupling\Modulation\Speeds\',int2str(prot),'_',name(a,:),'_COMODO_mean_states');
