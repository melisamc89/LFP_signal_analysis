...
for i=1:length(init)-1
    for j=1:floor(size(matrix_low,2)/5)
        x=matrix_low(init(i):init(i+1)-1,(j-1)*5+1:j*5);
        y=matrix_low(init(i)+1:init(i+1),(j-1)*5+1:j*5);
        z=matrix_high(init(i):init(i+1)-1,(j-1)*5+1:j*5);
...
subplot(2,5,7)
plot(mi_phase_all(1,:),reshape(mi_amplitude(4,:,:),[size(mi_amplitude,2) 20])')
hold on
...
subplot(2,5,[4,5])
errorbar([-36,-6,-0.5,0.5,6,36],mu,sqrt(sigma))
hold on
%plot([-36,-6,0.5,0.5,6,36],mu)
plot([-36,-6,-0.5,0.5,6,36],mi_all)
...
subplot(3,5,1)
histogram(mi_1(3,~isnan(mi_1(3,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_1(3)=mean(mi_1(3,~isnan(mi_1(3,1:20))));sigma_1(3)=var(mi_1(3,~isnan(mi_1(3,1:20))));
x=0:0.0005:0.05;
y=exp(-(x-mu_1(3)).*(x-mu_1(3))/(2*sigma_1(3)))/sqrt(2*pi*sigma_1(3));y=y/sum(y);
plot(x,y,'b','Linewidth',2)
histogram(mi_1(3,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_2(3)=mean(mi_1(3,end-20:end));sigma_2(3)=var(mi_1(3,end-20:end));
x=0:0.0005:0.05;
y=exp(-(x-mu_2(3)).*(x-mu_2(3))/(2*sigma_2(3)))/sqrt(2*pi*sigma_2(3));y=y/sum(y);
plot(x,y,'r','Linewidth',2)
xlim([0 0.01])

subplot(3,5,2)
histogram(mi_1(4,~isnan(mi_1(4,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_1(4)=mean(mi_1(4,~isnan(mi_1(4,1:20))));sigma_1(4)=var(mi_1(4,~isnan(mi_1(4,1:20))));
x=0:0.0005:0.05;
y=exp(-(x-mu_1(4)).*(x-mu_1(4))/(2*sigma_1(4)))/sqrt(2*pi*sigma_1(4));y=y/sum(y);
plot(x,y,'b','Linewidth',2)
histogram(mi_1(4,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_2(4)=mean(mi_1(4,end-20:end));sigma_2(4)=var(mi_1(4,end-20:end));
x=0:0.0005:0.05;
y=exp(-(x-mu_2(4)).*(x-mu_2(4))/(2*sigma_2(4)))/sqrt(2*pi*sigma_2(4));y=y/sum(y);
plot(x,y,'r','Linewidth',2)
xlim([0 0.01])

subplot(3,5,6)
histogram(mi_1(2,~isnan(mi_1(2,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_1(2)=mean(mi_1(2,~isnan(mi_1(2,1:20))));sigma_1(2)=var(mi_1(2,~isnan(mi_1(2,1:20))));
x=0:0.0005:0.05;
y=exp(-(x-mu_1(2)).*(x-mu_1(2))/(2*sigma_1(2)))/sqrt(2*pi*sigma_1(2));y=y/sum(y);
plot(x,y,'b','Linewidth',2)
histogram(mi_1(2,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_2(2)=mean(mi_1(2,end-20:end));sigma_2(2)=var(mi_1(2,end-20:end));
x=0:0.0005:0.05;
...
subplot(3,5,7)
histogram(mi_1(5,~isnan(mi_1(5,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_1(5)=mean(mi_1(5,~isnan(mi_1(5,1:20))));sigma_1(5)=var(mi_1(5,~isnan(mi_1(5,1:20))));
x=0:0.0005:0.05;
y=exp(-(x-mu_1(5)).*(x-mu_1(5))/(2*sigma_1(5)))/sqrt(2*pi*sigma_1(5));y=y/sum(y);
plot(x,y,'b','Linewidth',2)
histogram(mi_1(5,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_2(5)=mean(mi_1(5,end-20:end));sigma_2(5)=var(mi_1(5,end-20:end));
x=0:0.0005:0.05;
y=exp(-(x-mu_2(5)).*(x-mu_2(5))/(2*sigma_2(5)))/sqrt(2*pi*sigma_2(5));y=y/sum(y);
plot(x,y,'r','Linewidth',2)
xlim([0 0.01])

subplot(3,5,11)
histogram(mi_1(1,~isnan(mi_1(1,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
...
plot(x,y,'b','Linewidth',2)
histogram(mi_1(1,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
...
subplot(3,5,12)
histogram(mi_1(6,~isnan(mi_1(6,1:20))),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_1(6)=mean(mi_1(6,~isnan(mi_1(6,1:20))));sigma_1(6)=var(mi_1(6,~isnan(mi_1(6,1:20))));
x=0:0.0005:0.05;
y=exp(-(x-mu_1(6)).*(x-mu_1(6))/(2*sigma_1(6)))/sqrt(2*pi*sigma_1(6));y=y/sum(y);
plot(x,y,'b','Linewidth',2)
histogram(mi_1(6,end-20:end),'Binwidth',0.0005,'Normalization','probability')
hold on
mu_2(6)=mean(mi_1(6,end-20:end));sigma_2(6)=var(mi_1(6,end-20:end));
x=0:0.0005:0.05;
y=exp(-(x-mu_2(6)).*(x-mu_2(6))/(2*sigma_2(6)))/sqrt(2*pi*sigma_2(6));y=y/sum(y);
plot(x,y,'r','Linewidth',2)
xlim([0 0.01])

subplot(3,5,[3,5])
errorbar([-36,-6,-0.5,0.5,6,36],mu_1,sqrt(sigma_1))
hold on
errorbar([-36,-6,-0.5,0.5,6,36],mu_2,sqrt(sigma_2))
...
for i=1:length(init)-1
    for j=1:floor((size(matrix_low,2)-200)/100)
        x=matrix_low(init(i):init(i+1)-1,(j-1)*100+1:j*100);
        y=matrix_low(init(i)+1:init(i+1),(j-1)*100+1:j*100);
        z=matrix_high(init(i):init(i+1)-1,(j-1)*100+1:j*100);
        x=reshape(x,[size(x,1)*size(x,2) 1]);
        y=reshape(y,[size(y,1)*size(y,2) 1]);
        index=find(x<0 & y>0);
        %index=init(i)+index;
...
%% plot first part speed
    mi_1(1,:)=mi(15,:); mi_1(7,:)=mi(2,:);
    mi_1(2,:)=mi(14,:); mi_1(8,:)=mi(3,:);
    mi_1(3,:)=mi(13,:); mi_1(9,:)=mi(4,:);
    mi_1(4,:)=mi(12,:); mi_1(10,:)=mi(5,:);
    mi_1(5,:)=mi(11,:); mi_1(11,:)=mi(6,:);
    mi_1(6,:)=mi(10,:); mi_1(12,:)=mi(7,:);
...
subplot(2,7,[4:7])
errorbar([-5,-4,-3,-2,-1,-0.5,0.5,1,2,3,4,5],mu,sqrt(sigma))
hold on
plot([-5,-4,-3,-2,-1,-0.5,0.5,1,2,3,4,5],mi_all)

subplot(2,7,8)
plot(mi_phase_all(1,:),reshape(mi_amplitude(2,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(7,:),'k','Linewidth',2)
subplot(2,7,9)
plot(mi_phase_all(1,:),reshape(mi_amplitude(3,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(8,:),'k','Linewidth',2)
subplot(2,7,10)
plot(mi_phase_all(1,:),reshape(mi_amplitude(4,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(9,:),'k','Linewidth',2)
subplot(2,7,11)
plot(mi_phase_all(1,:),reshape(mi_amplitude(5,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(10,:),'k','Linewidth',2)
subplot(2,7,12)
plot(mi_phase_all(1,:),reshape(mi_amplitude(6,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(11,:),'k','Linewidth',2)
subplot(2,7,13)
plot(mi_phase_all(1,:),reshape(mi_amplitude(7,:,:),[size(mi_amplitude,2) 20])')
hold on
plot(mi_phase_all(1,:),mi_amplitude_all(12,:),'k','Linewidth',2)
